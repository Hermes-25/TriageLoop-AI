...
| TL-07 Final | 3-4 Sep | `START TL-07 FINAL` | Internal complete / publication gates | User approved launch on 22 Aug; isolated rehearsal, 2:05 MP4, repository scrub, 73 tests, production build, Vercel deployment, public browser journey and Docker Compose build/browser/restart/persistence/reset gate pass. GitHub, identity fields, video upload and portal submission remain external. |
