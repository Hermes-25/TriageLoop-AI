...
\hypersetup{colorlinks=true,linkcolor=TBrand,citecolor=TInfo,urlcolor=TInfo,pdftitle={TriageLoop: A Safety-Oriented, Deadline-Aware Control Loop for Emergency-Department Waiting Rooms},pdfauthor={Abhishek Das, Team Zeta}}
\urlstyle{same}
...
Authors: & Abhishek Das, Final Year, IIT Guwahati - Team Zeta \\
\end{tabular}
\vspace{10mm}
...
15-20 simulated patients & Twenty-patient live board plus 28 curated fixtures and 10,000 generated encounters & Automated count/coverage tests and deterministic demo reset \\
...
Twenty-eight deterministic fixtures cover ambiguous presentations, pediatric and geriatric states, no-history intake, missing and stale data, worsening vital signs, hard-rule/model conflict, compound triggers, multiple critical patients, NBO unavailability, and override/audit behavior. Twenty of these appear on the scrollable live board so the jury can verify the stated prototype minimum directly while the full set remains in automated tests.
